...
export function VesselDetail({ vessel, onClose }: VesselDetailProps) {
  ...
  const isLive = typeof props.source === 'string' && (props.source.startsWith('aisstream') || props.source.startsWith('aishub') || props.source.startsWith('vesselapi'));
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 8, color: 'rgba(255,255,255,0.35)' }}>
          {isLive
            ? 'Live AIS position via AISStream.io.'
